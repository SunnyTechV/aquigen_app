...
import com.tvg.erp.domain.SecurityRole;
...
import com.tvg.erp.service.SecurityUserService;
...
class SecurityUserResourceIT {
    ...
    @Test
    @Transactional
    void getAllSecurityUsersByRawMaterialMasterIsEqualToSomething() throws Exception {
        // Initialize the database
        securityUserRepository.saveAndFlush(securityUser);
        ...
        em.persist(rawMaterialMaster);
        em.flush();
        securityUser.addRawMaterialMaster(rawMaterialMaster);
        securityUserRepository.saveAndFlush(securityUser);
        Long rawMaterialMasterId = rawMaterialMaster.getId();

        // Get all the securityUserList where rawMaterialMaster equals to rawMaterialMasterId
        defaultSecurityUserShouldBeFound("rawMaterialMasterId.equals=" + rawMaterialMasterId);

        // Get all the securityUserList where rawMaterialMaster equals to (rawMaterialMasterId + 1)
        defaultSecurityUserShouldNotBeFound("rawMaterialMasterId.equals=" + (rawMaterialMasterId + 1));
    }
