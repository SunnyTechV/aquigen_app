...
describe('PurchaseOrder Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call RmInventory query and add missing value', () => {
      ...
      const rmInventory: IRmInventory = { id: 16522 };
      purchaseOrder.rmInventory = rmInventory;

      const rmInventoryCollection: IRmInventory[] = [{ id: 73220 }];
    ...
    it('Should update editForm', () => {
      const purchaseOrder: IPurchaseOrder = { id: 456 };
      const rmInventory: IRmInventory = { id: 30801 };
      purchaseOrder.rmInventory = rmInventory;
