...
describe('RawMaterialMaster Management Component', () => {
  let comp: RawMaterialMasterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'raw-material-master', component: RawMaterialMasterComponent }]),
      ...
      .overrideTemplate(RawMaterialMasterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rawMaterialMasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
