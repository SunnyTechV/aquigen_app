...
/**
 * A DTO for the {@link com.tvg.erp.domain.ConsumptionDetails} entity.
 */
public class ConsumptionDetailsDTO implements Serializable {
    ...
    private RmInventoryDTO rmInventory;
    ...
    public RmInventoryDTO getRmInventory() {
        return rmInventory;
    }

    public void setRmInventory(RmInventoryDTO rmInventory) {
