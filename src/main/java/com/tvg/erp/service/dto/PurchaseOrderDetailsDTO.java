...
/**
 * A DTO for the {@link com.tvg.erp.domain.PurchaseOrderDetails} entity.
 */
public class PurchaseOrderDetailsDTO implements Serializable {
    ...
    private RawMaterialMasterDTO rawMaterialMaster;
    ...
    public RawMaterialMasterDTO getRawMaterialMaster() {
        return rawMaterialMaster;
    }

    public void setRawMaterialMaster(RawMaterialMasterDTO rawMaterialMaster) {
    ...
    public String toString() {
        return "PurchaseOrderDetailsDTO{" +
            ...
            ", rawMaterialMaster=" + getRawMaterialMaster() +
            ", unit=" + getUnit() +
            "}";
    }
}
