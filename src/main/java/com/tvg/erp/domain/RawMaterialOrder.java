...
public class RawMaterialOrder implements Serializable {
    ...
    public void setRawMaterialMasters(Set<RawMaterialMaster> rawMaterialMasters) {
        if (this.rawMaterialMasters != null) {
            this.rawMaterialMasters.forEach(i -> i.removeRawMaterialOrder(this));
        }
        if (rawMaterialMasters != null) {
            rawMaterialMasters.forEach(i -> i.addRawMaterialOrder(this));
        }
        this.rawMaterialMasters = rawMaterialMasters;
    }

    public RawMaterialOrder rawMaterialMasters(Set<RawMaterialMaster> rawMaterialMasters) {
        this.setRawMaterialMasters(rawMaterialMasters);
        return this;
    }

    public RawMaterialOrder addRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMasters.add(rawMaterialMaster);
        rawMaterialMaster.getRawMaterialOrders().add(this);
        return this;
    }

    public RawMaterialOrder removeRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMasters.remove(rawMaterialMaster);
        rawMaterialMaster.getRawMaterialOrders().remove(this);
        return this;
    }
