...
public class Categories implements Serializable {
    ...
    public void setRawMaterialMasters(Set<RawMaterialMaster> rawMaterialMasters) {
        if (this.rawMaterialMasters != null) {
            this.rawMaterialMasters.forEach(i -> i.setCategories(null));
        }
        if (rawMaterialMasters != null) {
            rawMaterialMasters.forEach(i -> i.setCategories(this));
        }
        this.rawMaterialMasters = rawMaterialMasters;
    }

    public Categories rawMaterialMasters(Set<RawMaterialMaster> rawMaterialMasters) {
        this.setRawMaterialMasters(rawMaterialMasters);
        return this;
    }

    public Categories addRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMasters.add(rawMaterialMaster);
        rawMaterialMaster.setCategories(this);
        return this;
    }

    public Categories removeRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMasters.remove(rawMaterialMaster);
        rawMaterialMaster.setCategories(null);
        return this;
    }
