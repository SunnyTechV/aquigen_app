...
public class Transfer implements Serializable {
    ...
    public Transfer transferId(Long transferId) {
    ...
    public RmInventory getRmInventory() {
        return this.rmInventory;
    }

    public void setRmInventory(RmInventory rmInventory) {
        this.rmInventory = rmInventory;
    }

    public Transfer rmInventory(RmInventory rmInventory) {
        this.setRmInventory(rmInventory);
        return this;
    }
