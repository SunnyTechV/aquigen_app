...
public class PurchaseOrderDetails implements Serializable {
    ...
    public RawMaterialMaster getRawMaterialMaster() {
        return this.rawMaterialMaster;
    }

    public void setRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMaster = rawMaterialMaster;
    }

    public PurchaseOrderDetails rawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.setRawMaterialMaster(rawMaterialMaster);
        return this;
    }
