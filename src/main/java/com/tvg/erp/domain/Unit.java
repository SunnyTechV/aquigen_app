...
public class Unit implements Serializable {
    ...
    public void setRawMaterialMasters(Set<RawMaterialMaster> rawMaterialMasters) {
        if (this.rawMaterialMasters != null) {
            this.rawMaterialMasters.forEach(i -> i.setUnit(null));
        }
        if (rawMaterialMasters != null) {
            rawMaterialMasters.forEach(i -> i.setUnit(this));
        }
        this.rawMaterialMasters = rawMaterialMasters;
    }

    public Unit rawMaterialMasters(Set<RawMaterialMaster> rawMaterialMasters) {
        this.setRawMaterialMasters(rawMaterialMasters);
        return this;
    }

    public Unit addRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMasters.add(rawMaterialMaster);
        rawMaterialMaster.setUnit(this);
        return this;
    }

    public Unit removeRawMaterialMaster(RawMaterialMaster rawMaterialMaster) {
        this.rawMaterialMasters.remove(rawMaterialMaster);
        rawMaterialMaster.setUnit(null);
        return this;
    }
